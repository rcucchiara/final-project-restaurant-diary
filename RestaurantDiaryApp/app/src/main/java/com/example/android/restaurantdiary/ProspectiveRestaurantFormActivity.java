...
public class ProspectiveRestaurantFormActivity extends AppCompatActivity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int phoneColumnIndex = cursor.getColumnIndex(ProspectiveRestaurantEntry.COLUMN_RESTAURANT_PHONE);
            int noteColumnIndex = cursor.getColumnIndex(ProspectiveRestaurantEntry.COLUMN_RESTAURANT_NOTE);
            int imageColumnIndex = cursor.getColumnIndex(ProspectiveRestaurantEntry.COLUMN_RESTAURANT_IMAGE);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mRestaurantHasChanged) {
                    NavUtils.navigateUpFromSameTask(ProspectiveRestaurantFormActivity.this);
                    return true;
                }
